        ...
        <section className="border">
          ...
          <div className="about-me flex flex-col gap-10">
            <article>
              <h2>Bonjour !</h2>
              <p>
                Ce portfolio incarne un voyage de 4 ans en informatique, marqué
                par la persévérance et enrichi de créativité ainsi que la
                passion.{" "}
              </p>
              <p>
            ...
            <article>
              ...
              <p>
                Voici un projet qui me tient à cœur. N'hésitez pas à découvrir
                aussi mes autres travaux.
              </p>
              <Project
                name="La jeu"
                tags={[
